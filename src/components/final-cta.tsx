        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="text-gray-600">(438)223-2322</div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="text-gray-900 mb-1">kingdomcleen@gmail.com</div>
                  <div className="text-gray-600">kingdomcleen@gmail.com</div>
                  <div className="text-gray-600">kingdomcleen@gmail.com</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  1338 Wellington St. W,</div>
                  <div className="text-gray-600">Ottawa, ON K1Y 3B7</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-2xl p-8 lg:p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <Label htmlFor="email">kingdomcleen@gmail.com</Label>
                <Input
                  id="email"
                  type="email"
